    ...
    <div className="flex flex-col gap-4 max-w-prose">
      <div>
        ...
        <p className="text-xl sm:text-l">
          {`Operating from the heart of Radnage, Buckinghamshire, we’re proud to offer our premium Real Estate, Aerial photography as well as video services across an expansive region, capturing breathtaking interior and aerial views that tell a unique story every time.`}
        </p>
      </div>
